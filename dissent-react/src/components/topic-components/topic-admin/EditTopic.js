  ...
  return (
    <form onSubmit={handleEditSubmit}>
      ...
      <div className="form-row mx-1">
        ...
        <input type="text" className="form-control mb-3 mx-2" id="topicName" name="topicName" defaultValue={topic.topicName} maxLength="255" required onChange={handleChange} />
